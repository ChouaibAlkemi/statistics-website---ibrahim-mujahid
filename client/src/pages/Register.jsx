  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center font-sans" dir="rtl">
        <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
            <h2 className="text-2xl font-bold text-slate-800 mb-6 text-center">إنشاء حساب جديد</h2>
            ...
            <p className="mt-4 text-center text-slate-600 text-sm">
                لديك حساب بالفعل؟ <Link to="/login" className="text-primary hover:underline">سجل الدخول</Link>
            </p>
        </div>
    </div>
  );
